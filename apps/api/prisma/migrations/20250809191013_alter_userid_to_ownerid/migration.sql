/*
  ...
  - Added the required column `owner_id` to the `tokens` table without a default value. This is not possible if the table is not empty.
...
-- AddForeignKey
ALTER TABLE "public"."tokens" ADD CONSTRAINT "tokens_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
